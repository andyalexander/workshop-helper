...
exception. ``InvalidInput`` arrives with its consumer, the pipe-bender's
cross-field refusal (#36) — shipping it here unexercised would mean inferring how
a field-targeted message renders, and that surface is not nil (§1.6).
"""
